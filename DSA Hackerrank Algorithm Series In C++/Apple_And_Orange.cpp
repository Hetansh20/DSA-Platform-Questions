...
void countApplesAndOranges(int s, int t, int a, int b, vector<int> apples, vector<int> oranges) {
    ...
    for (int apple_dist : apples) {
        // Calculate the final position of the apple
        int apple_pos = a + apple_dist;
        // Check if it lands on the house
    ...
    for (int orange_dist : oranges) {
        // Calculate the final position of the orange
        int orange_pos = b + orange_dist;
        // Check if it lands on the house
